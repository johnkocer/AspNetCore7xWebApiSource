...
namespace SmartItCodecamp.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HireDate,Id,LastName,FirstName")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HireDate,Id,LastName,FirstName")] Instructor instructor)
        {
            if (id != instructor.Id)
            {
                return NotFound();
