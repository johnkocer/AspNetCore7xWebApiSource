...
namespace Employee.Mvc.Ui.Controllers
{
  ...
  public class EmployeeController : ControllerBase
  {
    ...
    [HttpPost]
    public IActionResult AddEmployee([FromBody]SmartIT.MockDB.Employee item)
    {
      if (item == null)
        return BadRequest();
      else
    ...
    [HttpPut]
    public IActionResult UpdateEmployee(int id, [FromBody]SmartIT.MockDB.Employee item)
    {
